  ...
  return (
    <div className="h-auto bg-[rgb(20,27,61)] min-h-screen p-2">
      <div className="h-[auto] w-[1000px] setting-main flex items-center flex-col justify-center bg-[#171F45] mx-auto my-5 p-7">
        <h1 class="text-3xl font-bold text-center mt-2 text-white mb-3 text-shadow">Dark Server Carding UC</h1>
        ...
        <div className='w-full m-auto flex items-center justify-center mb-3 gap-5'>
          ...
          <input
            ...
            className="w-[50%] bg-white border-none border-gray-300 rounded p-2 "
          />
          <button
